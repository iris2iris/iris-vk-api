...
Гибкая система получения получаемых данных. После обновления API вам не придётся ждать обновления структуры данных
в ваших прежних библиотеках. Все данные будут доступны сразу же после обновлений самого VK API.
